...
async def gali_command(client, message):
    ...
    # Stylish Bold Fonts
    ADMIN_ONLY = "**🚫 𝗢𝗻𝗹𝘆 𝗔𝗱𝗺𝗶𝗻𝘀 𝗮𝗻𝗱 𝗢𝘄𝗻𝗲𝗿𝘀 𝗮𝗿𝗲 𝗮𝗹𝗹𝗼𝘄𝗲𝗱 𝘁𝗼 𝘂𝘀𝗲 𝘁𝗵𝗶𝘀 𝗰𝗼𝗺𝗺𝗮𝗻𝗱!**"
    TRY_IN_DM = "**💬 𝗜𝗳 𝘆𝗼𝘂 𝘄𝗮𝗻𝘁 𝘁𝗼 𝘂𝘀𝗲 𝘁𝗵𝗶𝘀 𝗰𝗼𝗺𝗺𝗮𝗻𝗱, 𝗽𝗹𝗲𝗮𝘀𝗲 𝘁𝗿𝘆 𝗶𝗻 𝗺𝘆 𝗗𝗠.**"

    # Check if user is admin or owner
    if member.status in ["administrator", "creator"]:  # Admin & Owner allowed
...
Cᴏᴍᴍᴀɴᴅ:
- /gali: Sᴇɴᴅs ᴀ ʀᴀɴᴅᴏᴍ ᴀʙᴜsɪᴠᴇ ᴀɴɢᴜᴀɢᴇ (gali).
